    ...
    <div class="card">
      ...
      >
        ...
        <template #list="slotProps">
          <div class="col-12">
            <div class="vod-list-item">
              <img
                :src="'http://localhost:8000' + slotProps.data.image_path"
                :alt="slotProps.data.name"
              />
              <div class="vod-list-detail">
                <div class="vod-name">{{ slotProps.data.name }}</div>
                <div class="vod-description">
                ...
                <Rating
                  ...
                  :cancel="false"
                ></Rating>
                <i class="pi pi-tag vod-category-icon"></i
                ><span class="vod-category">{{ slotProps.data.category }}</span>
              </div>
              <div class="vod-list-action">
                <span class="vod-price">${{ slotProps.data.price }}</span>
                <Button
